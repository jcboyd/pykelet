...
If we are to correct the segmentation done when creating the reference segmenter training set, it is useful to note segmentation is done simply by placing the delimeters, i.e. the labels.
