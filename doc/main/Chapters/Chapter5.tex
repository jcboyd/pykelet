...
Interestingly, removing the basic baseline features addressing punctuation \emph{improved} performance, both with and without our own character class features (compare Binary with Binary only etc.).
