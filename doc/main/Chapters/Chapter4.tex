...
\centering
\begin{tabular}{cccc}
\subfloat[A]{\includegraphics[width=0.5\textwidth]{Figures/body_formula.pdf}} & 
\subfloat[B]{\includegraphics[width=0.5\textwidth]{Figures/body_normal.pdf}}\\
\subfloat[C]{\includegraphics[width=0.5\textwidth]{Figures/headnote.pdf}}&
\subfloat[D]{\includegraphics[width=0.5\textwidth]{Figures/page.pdf}} \\
\subfloat[E]{\includegraphics[width=0.5\textwidth]{Figures/affiliations_list.pdf}} & 
\subfloat[F]{\includegraphics[width=0.5\textwidth]{Figures/author_list.pdf}} \\ 
\end{tabular}
