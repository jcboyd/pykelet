...
Maximum entropy classifiers, also known as multinomial logistic regression, are
...
where ... Newton's method takes a step in the direction minimising a second-order approximation of the cost function,
